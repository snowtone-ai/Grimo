---
name: grimo-frontend
description: Grimo frontend rules for explicit UI/UX implementation or targeted QA.
---
...
- Use `DESIGN.md` only for actual UI/UX work.
- Do not create Storybook stories or run Storybook, Playwright, visual, a11y, or Vercel reviews by default.
- Use targeted verification only when the changed behavior needs it. Broader frontend QA is for explicit requests, release/Human Gate work, or a concrete regression risk.
